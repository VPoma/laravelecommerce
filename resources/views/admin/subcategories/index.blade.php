<x-admin-layout :breadcrumbs="[
    ...
    @else
        <div class="flex p-4 text-sm text-blue-800 rounded-base bg-brand-softer border border-brand-subtle"
            role="alert">
            ...
            <div>
                <span class="font-medium">Todavía no hay categorias de productos registrados.</span>
            </div>
        </div>
